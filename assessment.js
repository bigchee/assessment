(function(){
    ...
    function removeAllchildren(element){
        while(element.firstChild){//子供の要素のある限り削除
...
const answers = [
    ...
    '{userName}のいいところは厳しさです。{userName}の厳しさが、ものごとをいつも成功に導きます。',
    ...
    '{userName}のいいところは好奇心です。新しいところに向かっていく{userName}の心構えにが多くの人に魅力的に映ります。',
